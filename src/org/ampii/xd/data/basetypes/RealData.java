...
public class RealData extends AbstractFloatingPointData {
    ...
    public RealData(String name, Object... initializers) throws XDException {
        super(name, initializers);
        prototype = Builtins.getPrototypeOfBase(Base.REAL);
    }

    @Override public Base    getBase() { return Base.REAL; }
