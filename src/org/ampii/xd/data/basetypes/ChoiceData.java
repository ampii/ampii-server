...
public class ChoiceData extends AbstractConstructedData {
    ...
    public ChoiceData(String name, Object... initializers) throws XDException {
        super(name, initializers);
        prototype = Builtins.getPrototypeOfBase(Base.CHOICE);
    }

    @Override public Base getBase() { return Base.CHOICE; }
