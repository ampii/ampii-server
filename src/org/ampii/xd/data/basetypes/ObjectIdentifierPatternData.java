 ...
 * @author daverobin
 */
public class ObjectIdentifierPatternData extends AbstractTextData {

    public ObjectIdentifierPatternData(String name, Object... initializers) throws XDException {
        super(name, initializers);
        prototype = Builtins.getPrototypeOfBase(Base.OBJECTIDENTIFIERPATTERN);
    }

    @Override public Base    getBase()  { return Base.OBJECTIDENTIFIERPATTERN; }

    @Override public void    setValue(Object newValue) throws XDException {
        preread();
        // native java format is a String with two comma separated parts, the instance part can be "*"
