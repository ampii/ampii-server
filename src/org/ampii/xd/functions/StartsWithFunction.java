...
/**
 * An Implementation of the .../startsWith() URI function, called from {@link Functions}
 */
public class StartsWithFunction extends Functions {
    ...
    static Data invoke(Data target, String argString) throws XDException {
        ...
        if (target.canHaveValue()) results.setValue(target.stringValue().startsWith(compareTo));
